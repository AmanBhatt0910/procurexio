...
// HTML email template builder functions extracted from mailer.js
      ...
      <td style="background:${bgColor};padding:22px 36px;">
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
          <tr>
            ...
            ${extraContent ? `
              <td align="right" style="color:#ffffff !important;">
                ${extraContent}
              </td>
            ` : ''}
          </tr>
...
// ─────────────────────────────────────────────────────────────────────────────
export function buildTeamInviteHtml({ inviteUrl, companyName, invitedBy, formattedRole, appName }) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
// ─────────────────────────────────────────────────────────────────────────────
export function buildVendorInviteHtml({ inviteUrl, vendorName, companyName, invitedBy, appName }) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
// ─────────────────────────────────────────────────────────────────────────────
export function buildWelcomeHtml({ name, companyName, dashboardUrl, vendorsUrl, rfqUrl, appName }) {
...
export function formatDeadlineDateTime(deadline) {
...
// ─────────────────────────────────────────────────────────────────────────────
// HTML: Vendor RFQ invite
// ─────────────────────────────────────────────────────────────────────────────
export function buildVendorRFQInviteHtml({ vendorName, companyName, rfqTitle, rfqReference, deadline, inviteLink, appName }) {
...
// ─────────────────────────────────────────────────────────────────────────────
export function buildPasswordResetHtml({ name, tempPassword, loginUrl, appName }) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
// ─────────────────────────────────────────────────────────────────────────────
export function buildPasswordResetTokenHtml({ name, resetUrl, appName }) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
