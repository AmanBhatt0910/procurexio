        ...
        <div className="panel-left">
          ...
          <div className="panel-left-content">
            ...
            <p className="panel-sub">
              Enter your work email and we&apos;ll send a temporary password straight to your inbox.
            </p>
          </div>
        </div>
          ...
          {submitted ? (
            <div className="form-success">
              ...
              <p className="form-success-sub">
                ...
                Use it to sign in, then update your password from account settings.
              </p>
            </div>
          ) : (
            <form className="auth-form" onSubmit={handleSubmit}>
              ...
              <AuthButton loading={loading}>Send temporary password</AuthButton>
            </form>
          )}
